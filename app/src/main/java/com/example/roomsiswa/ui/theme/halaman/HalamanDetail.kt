...
fun DetailsScreen(
    ...
    Scaffold (
        topBar = {
            ...
            FloatingActionButton(
                onClick = { navigateToEditItems(uiState.value.detailSiswa.id) },
...
@Composable
fun ItemDetailsRow(labelResID: Int, itemDetail: String, modifier: Modifier = Modifier) {
